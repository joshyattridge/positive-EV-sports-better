...
class TestRealWorldEVScenarios:
    ...
    def test_large_edge_favorite(self, mock_bookmakers):
        ...
        # Only Strong Team has positive EV in this scenario
        # Strong Team: Pinnacle 1.50 (66.67%) vs Bet365 1.70 = +13.33% EV
        # Weak Team: Pinnacle 4.00 (25%) vs Bet365 3.50 = -12.5% EV (negative, filtered out)
        assert len(opportunities) == 1
        
        # Find the favorite (Strong Team) opportunity
        strong_team_opp = opportunities[0]
        assert strong_team_opp['outcome'] == 'Strong Team'
        
        # Pinnacle sharp odds: Strong Team 1.50, Weak Team 4.00
        # True prob Strong Team = 1/1.50 = 66.67%
        # Bet365 odds: 1.70
        # EV = (true_prob × (odds - 1)) - (1 - true_prob)
        # EV = (0.6667 × 0.70) - 0.3333 = 0.4667 - 0.3333 = 0.1334 = 13.34%
        assert strong_team_opp['ev_percentage'] == pytest.approx(13.33, rel=0.1)
